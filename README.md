...
- Native tracking package with signed-nanosecond trajectory and IMU primitives, IMU history interpolation, raw-sample IMU preintegration/reintegration, IMU bias continuity and marginalization-prior anchoring inside the optional sliding window, per-point LiDAR deskew, bounded 6-DoF LiDAR residual correction, direct LiDAR/Gaussian-map point-to-point window factors, visual residual and direct image-alignment comparison against mapper renders, chunk-complete GaussianMap snapshot caching, odometry/path/optional TF publication, and deterministic probes.
